...
class Pairwise(nn.Module):
    ...
    def forward(self, mm, coords=None, nb_regions=None):
        """
        mm: multimodal features
            shape: (batch, n_image_region, feature_len)
        """
        ...
        # elif self.agg_type == 'weldon':
        #     mm_new = weldon(Rij, dim=2,
        #                    kmax=self.agg_opt['kmax'],
        #                    kmin=self.agg_opt['kmin'])
        else:
